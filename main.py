...
@cli.command()
@click.option('--config', type=click.Choice(['base', 'pdr', 'max', 'max_no_ser_tab', 'max_nst_o3m', 'max_st_o3m', 'local_llama70b', 'local_llama8b', 'gemini_thinking']), default='base', help='Configuration preset to use')
