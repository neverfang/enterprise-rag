...
class QuestionsProcessor:
    def __init__(
        ...
        use_metadata_routing: bool = False,
        ...
        self.use_metadata_routing = use_metadata_routing
    ...
    def _extract_references(self, pages_list: list, company_name: str) -> list:
        ...
        if self.subset_path is None:
            raise ValueError("subset_path is required for metadata routing pipeline when processing references.")
    ...
    def _post_process_submission_answers(self, processed_questions: List[dict]) -> List[dict]:
        ...
        for q in processed_questions:
            ...
            if value == "N/A":
                ...
                # Convert page indices from one-based to zero-based (output requires 0-based page indices, but for debugging it is easier to use 1-based)
                references = [
                    {
